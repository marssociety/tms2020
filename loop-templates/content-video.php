...
<article <?php post_class(); ?> id="post-<?php the_ID(); ?>">
    ...
    <div class="container entry-meta mt-2 ml-0 mr-0 p-0">
        <div class="row m-0">
            <div class="col-12 col-md-3 col-sm-12 post-date"><?php the_time('F jS, Y'); ?></div>
            <div class="col-12 col-md-6 col-sm-12 post-tags p-0"><?php the_tags('<i class="fa fa-tag"></i> ', ', '); ?></div>
            <div class="col-12 col-md-3 col-sm-12 text-right"><a href="<?php get_post_permalink(); ?>">Permalink</a></div>
        </div><!-- .row -->
        <div class="row m-0">
