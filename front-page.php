...
<main class="site-main" id="main">
	<div class="front-page-container news-highlights-section container-fixed news-announcements">
			<?php
					...
					<div class="card-body post-item p-0">
						<div class="front-page-post-image card-img-top p-0"><?php echo the_post_thumbnail('front-post-thumbnail',array( 'class' => 'w-100 img-fluid' )); ?></div>
							<div class="post-info front-page-post-info p-3">
								...
								<h2 class="post-title front-page-post-title"><a href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h2>
								<div class="post-content front-page-post-excerpt"><?php the_excerpt(); ?></div>
							</div>
					</div>
				</div> <!-- card -->
			</div><!-- front-page-post -->
	...
	<div class="front-page-container video-highlights-section container-fixed ml-0 mr-0 mt-3 pb-3 mb-0 pt-4">
		<div class="row">
			<div class="col mb-3">
				<h2 class="front-page-header">Featured Videos</h2>
			</div>
		</div>
		<div class="row">
	<?php
		...
		<div class="row" id="video-more">
			<div class="col-12 col-md-4 col-sm-12 video-more-link-1"><a href="https://www.youtube.com/user/TheMarsSociety/playlists?view=50&sort=dd&shelf_id=2">Annual Convention Videos</a></div>
			<div class="col-12 col-md-4 col-sm-12 video-more-link-2"><a href="https://www.youtube.com/user/TheMarsSociety/playlists">All YouTube Playlists</a></div>
			<div class="col-12 col-md-4 col-sm-12 video-more-link-3"><a href="/videos/">More Featured Videos ></a></div>
		</div><!-- row -->
